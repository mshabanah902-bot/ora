...
<img src={myLogo} alt="ORA Logo" className="h-14 sm:h-20 w-auto max-w-[120px] object-contain" />
          ...
          <div className="flex items-center gap-1 sm:gap-3 relative" ref={searchRef}>
            ...
            <div className="relative">
              ...
              <AnimatePresence>
                {wishlistOpen && <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 8 }} className="fixed top-20 left-3 right-3 w-auto max-h-[calc(100vh-6rem)] overflow-y-auto sm:absolute sm:top-12 sm:left-auto sm:right-0 sm:w-80 sm:max-h-none rounded-2xl bg-white p-3 text-[#1e1f22] shadow-xl border border-charcoal-100 z-[70]" dir="rtl">
